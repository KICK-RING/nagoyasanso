  ...
  <div class="c-page">
    <section class="c-page-visual">
      ...
      <div class="c-page-container">
        ...
        <div class="c-page-breadcrumbs"><a href="/">HAGOYA SANSO HOME</a><span class="c-page-breadcrumbs__arrow">></span>医療用ガス</div>
      </div>
    </section>

    <section class="c-service">
      <section class="c-service-wrap">
        <div class="c-service-wrap--ttl">命に大きく関わる医療の現場を支える</div>
        <div class="c-service-wrap--desc">
          病院では、様々なものを高度に使用して病気やケガに苦しんでいる<br>
          患者さんの命や暮らしを守るため医療従事者の方々が日々奮闘されています。<br>
          その現場でも医療用として使用される【ガス】の存在は欠かすことができません。<br>
          例えば、吸入（呼吸）用の「酸素」ガスも医療用ガスのひとつで<br>
          みなさんもよくご存知だと思います。<br>
          その他には、手術時の麻酔用として使用される「亜酸化窒素」ガス（別名「笑気ガス」）や、微生物やウイルスなどの殺（滅）菌・消毒用として使用される「酸化エチレン」ガスなど、医療現場でも【ガス】は密接な関わりをもっています。<br>
